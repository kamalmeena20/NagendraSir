  ...
  return (
    <div className="space-y-6">
      ...
      <button
        ...
        className="px-4 py-2 bg-[#009E66] text-white rounded-lg"
      >
        + Add Collaborator
      </button>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        {list.map((inst) => (
          <div key={inst._id} className="p-5 bg-white rounded shadow">
            <img
              src={inst.logoUrl}
              className="object-contain w-24 h-24 mx-auto"
              alt="loading"
            ...
            <ul className="mt-2 ml-5 text-gray-700 list-disc">
      ...
      {modalOpen && (
        <div className="fixed inset-0 flex items-center justify-center p-4 bg-black/40">
          <div className="w-full max-w-md p-6 space-y-4 bg-white rounded shadow-lg">
            <h2 className="text-xl font-semibold">
              {editingId ? "Edit Institute" : "Add Institute"}
            </h2>
            ...
            {form.logoUrl && (
              <img
                src={form.logoUrl}
                className="w-20 h-20 mx-auto mt-2 border rounded"
                alt="loading"
              />
            )}
